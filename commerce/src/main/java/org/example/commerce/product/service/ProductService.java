...
import org.example.commerce.product.entity.ProductResponseDto;
...
public class ProductService {
    ...
    //주문 생성
    @Transactional
    public ProductResponseDto createProduct(Long userId, ProductCreateDto createDto){
        ...
        productEntity.orderCount(createDto.getCount(),userEntity);
        productRepository.save(productEntity);

        return ProductResponseDto.toDto(userEntity, productEntity, createDto.getCount());
    }
}
